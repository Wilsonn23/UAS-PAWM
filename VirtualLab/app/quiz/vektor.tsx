...
const questions: Question[] = [
  {
    ...
    options: [
      ...
      'Besaran yang selalu positif'
    ],
    correctAnswer: 1
  },
  {
    id: 2,
    question: 'Manakah yang termasuk besaran vektor?',
    options: [
      'Massa',
      'Suhu',
      'Kecepatan',
  ...
  {
    id: 3,
    question: 'Jika vektor A = 3i + 4j, besar magnitude vektor A adalah?',
    options: [
      '5',
      '7',
      '12',
  ...
  {
    id: 4,
    question: 'Metode penjumlahan vektor yang menggunakan aturan segitiga disebut?',
    options: [
      'Metode analitis',
      'Metode poligon',
  ...
  {
    id: 5,
    question: 'Hasil dari penjumlahan dua vektor yang sama besar dan berlawanan arah adalah?',
    options: [
      'Vektor dengan besar dua kali vektor awal',
      'Vektor dengan besar setengah vektor awal',
      'Vektor nol',
      'Vektor dengan arah tegak lurus'
    ],
    correctAnswer: 2
  }
];

export default function QuizVektorScreen() {
